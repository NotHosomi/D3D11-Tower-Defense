...
public:
	...
	static IndexedTriangleList<V> Make()
	{
		...
		constexpr float extents = 1.0f / 2.0f;

		std::vector<V> vertices(8);
		vertices[0].pos = { -extents,-extents,-extents };
		vertices[1].pos = { extents,-extents,-extents };
		vertices[2].pos = { -extents,extents,-extents };
		vertices[3].pos = { extents,extents,-extents };
		vertices[4].pos = { -extents,-extents,extents };
		vertices[5].pos = { extents,-extents,extents };
		vertices[6].pos = { -extents,extents,extents };
		vertices[7].pos = { extents,extents,extents };
	...
	static IndexedTriangleList<V> MakeSkinned()
	{
		...
		vertices[8].pos = { -extents,-extents,-extents };
		vertices[8].tex = { 2.0f / 3.0f,4.0f / 4.0f };
		vertices[9].pos = { extents,-extents,-extents };
		vertices[9].tex = { 1.0f / 3.0f,4.0f / 4.0f };
		vertices[10].pos = { -extents,-extents,-extents };
		vertices[10].tex = { 3.0f / 3.0f,1.0f / 4.0f };
		vertices[11].pos = { -extents,-extents,extents };
		vertices[11].tex = { 3.0f / 3.0f,2.0f / 4.0f };
		vertices[12].pos = { extents,-extents,-extents };
		vertices[12].tex = { 0.0f / 3.0f,1.0f / 4.0f };
		vertices[13].pos = { extents,-extents,extents };
